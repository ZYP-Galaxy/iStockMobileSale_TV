...
public class frmsaleorderlist extends AppCompatActivity implements View.OnClickListener {
    public static String url;
    private JsonArrayRequest request;
    public static RequestQueue requestQueue;
    public static ArrayList<saleorderlist> saleorderlists = new ArrayList<>();
    ...
    public static saleorderListAdp adp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frmsaleorderlist);
        listcontext=frmsaleorderlist.this;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId()== R.id.add) {
            Intent intent=new Intent(frmsaleorderlist.this,sale_entry.class);
    ...
    private void setUI() {
        rcv= findViewById(R.id.rcvsaleorderList );
        pb=new ProgressDialog(frmsaleorderlist.this,R.style.AlertDialogTheme);
        ...
        findViewById(R.id.imgAdd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(frmsaleorderlist.this,saleorder_entry.class);
                startActivity(intent);
                finish();
        ...
        adp=new saleorderListAdp(frmsaleorderlist.this,saleorderlists);
        rcv.setAdapter(adp);
        LinearLayoutManager lm=new LinearLayoutManager(frmsaleorderlist.this,LinearLayoutManager.VERTICAL,false);
        ...
        selectfilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectfilter.getText().toString().trim().equals("Choose Customer") || (filterV==1 && !selectfilter.getText().toString().trim().equals("Choose User") && !selectfilter.getText().toString().trim().equals("Choose") && !selectfilter.getText().toString().trim().equals("Choose Location") && !selectfilter.getText().toString().trim().equals("Choose Brand"))){
                    ...
                    AlertDialog.Builder bd=new AlertDialog.Builder(frmsaleorderlist.this,R.style.AlertDialogTheme);
                    bd.setTitle("iStock");
        ...
        try {
            ...
            imgSearch.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        AlertDialog.Builder searchBuilder = new AlertDialog.Builder(frmsaleorderlist.this,R.style.AlertDialogTheme);
                                ...
                                if (!etdSearch.getText().toString().isEmpty()) {
                                    switch (name) {
                                        case "Customer":
                                            ...
                                            FilterCustomer ca = new FilterCustomer(frmsaleorderlist.this, filteredcustomer, btn, da,"SaleOrder");
                                            rv.setAdapter(ca);
                                        ...
                                        case "User":
                                            ...
                                            FilterUser us = new FilterUser(frmsaleorderlist.this, filtereduser, btn, da,"SaleOrder");
                                            rv.setAdapter(us);
                                        ...
                                        case "Location":
                                            ...
                                            FilterLocation loc = new FilterLocation(frmsaleorderlist.this, filteredloc, btn, da,"SaleOrder");
                                            rv.setAdapter(loc);
            ...
            switch (name) {
                case "Customer":
                    ...
                    FilterCustomer cad = new FilterCustomer(frmsaleorderlist.this, customers, btn, da,"SaleOrder");
                    rv.setAdapter(cad);
                ...
                case "User":
                    ...
                    cursor.close();
                    FilterUser us = new FilterUser(frmsaleorderlist.this, users, btn, da,"SaleOrder");
                    rv.setAdapter(us);
                    GridLayoutManager gridLayoutManagerUser = new GridLayoutManager(frmsaleorderlist.this, 4);
                    rv.setLayoutManager(gridLayoutManagerUser);
                    da.show();
                    break;
                ...
                case "Location":
                    ...
                    FilterLocation lad = new FilterLocation(frmsaleorderlist.this, locs, btn, da,"SaleOrder");
                    rv.setAdapter(lad);
                ...
                case "Brand":
                    ...
                    if (cursor != null && cursor.getCount() != 0) {
                        while (cursor.moveToNext() && cursor.getLong(cursor.getColumnIndex("BrandID"))!=0){//Added by KLM 11122020
...
//                        }
                    ...
                    cursor.close();
                    FilterBrand B = new FilterBrand(frmsaleorderlist.this,brands,btn,da,"SaleOrder");
                    rv.setAdapter(B);
                    GridLayoutManager gridLayoutManagerUserBrand= new GridLayoutManager(frmsaleorderlist.this, 4);
    ...
    private void showfiltermenu(){
        ...
        PopupMenu popup = new PopupMenu(frmsaleorderlist.this,filtermenu);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent=new Intent(frmsaleorderlist.this,frmmain.class);
        startActivity(intent);
        finish();
    }
    public static void GetData() {
        try {
            ...
            pb.show();
            saleorderlists.clear();
            total=0.0;
            String ip = sh_ip.getString("ip", "empty");
            String port = sh_port.getString("port", "empty");
            url = "http://"+ip+":"+port+"/api/DataSync/GetHeader'?userid="+frmlogin.LoginUserid+"&uid="+FilterUser.uid+"&fdate="+dateFormat.format(fdate)+"&tdate="+dateFormat.format(tdate)+"&ccid="+FilterCustomer.ccid+"&locid="+FilterLocation.locid+"&branid="+FilterBrand.uid+"&language="+frmlogin.Font_Language+"&order=true";
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        for(int i=0;i<jarr.length();i++)
                        {
                            ...
                            int cancel=obj.optInt("cancel",0);
                            saleorderlists.add(new saleorderlist(tranid,dateStr,docid,pay_type,currency,net_amount,usershort,customer_name,cancel));


                        }
                        adp.notifyDataSetChanged();
                        txtCount.setText(String.valueOf(saleorderlists.size()));
    ...
    private void ShowDateFilter() {
        LayoutInflater inflater = (LayoutInflater) frmsaleorderlist.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View layout = inflater.inflate(R.layout.daterangefilterpopup,null);
        float density=frmsaleorderlist.this.getResources().getDisplayMetrics().density;
